...
- **OpenAPI client generation** — `Cli.from_openapi("spec.json")` turns any OpenAPI 3.0 spec into a working CLI; path params become args, query params become options, HTTP calls via stdlib `urllib`
